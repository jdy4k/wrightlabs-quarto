...
![grid_image](/images/tutorial-images/Cyberduck3.png)
...
![grid_image](/images/tutorial-images/Cyberduck5.png)

:::

:::{.g-col-6}

![grid_image](/images/tutorial-images/Cyberduck4.png)
...
```{.no-copy}
Running scripts off worker nodes
```
...
![image](/images/tutorial-images/ScriptAnnotated.png)

<details>
<summary> Expand for plain text unannotated version </summary>
```
#!/bin/bash
# PBS -l nodes=1:ppn=6
#PBS -N qiime2 import
...
## before running script make a mapping file as described in the tutorial This is
## important because it points to the forward and reverse reads which will
## be imported
...
```{.no-copy}
Editing through the Cluster
```

<div class="code-explanation">

  - `nano [SCRIPT NAME]` when you are in the same folder as the script you want to edit
  ...
  - Save your changes (<kbd>CTRL</kbd> + <kbd>X</kbd>)
  - Then press <kbd>y</kbd>
